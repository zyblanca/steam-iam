...
import static com.crc.crcloud.steam.iam.common.utils.SagaTopic.Project.PROJECT_DISABLE;
...
@Slf4j
public class SagaProjectDisableEventListener implements ApplicationListener<IamProjectEnableEvent> {
    ...
    @Override
    @Saga(code = PROJECT_DISABLE, description = "steam-iam-disable-project启用项目", inputSchemaClass = ProjectEventPayload.class)
